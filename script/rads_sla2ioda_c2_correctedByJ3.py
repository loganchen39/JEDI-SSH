...
def main():
  # sats = ['c2', 'j2', 'sa', '3a', 'j3']  # for 2016
  # sats = [      'j2', 'sa', '3a', 'j3']
  # sats = [      'j2']  # for creating dummy obs with 1 value;
  # sats = ['c2', 'j2', 'sa']  # for 2015

  # sats = ['3a', '3b', '6a', 'c2', 'e2', 'g1', 'j1', 'j2', 'j3', 'n1', 'pn', 'sa', 'tx']  # for 2000~2022
  # sats = [      '3b', '6a', 'c2', 'e2', 'g1', 'j1', 'j2', 'j3', 'n1', 'pn', 'sa', 'tx']  # for 2000~2022
  # sats = [                        'e2', 'g1', 'j1', 'j2'                              ]  # for 2000~2022
  # sats = [                                    'j1', 'j2'                              ]  # for 2000~2022
  # sats = [                                          'j2'                              ]  # for 2000~2022

    sats = ['c2']  # for c2 corrected by j3 for 2022 Feb.
    ...
    for sat in sats:
        ...
        while jday <= jday_end:
          ...
          # fn = sat + '_' + jday.strftime('%Y%j') + '.nc'
            fn = sat + '_' + jday.strftime('%Y%m%d') + '.nc'
